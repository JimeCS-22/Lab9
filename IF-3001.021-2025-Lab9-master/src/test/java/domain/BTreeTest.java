...
class BTreeTest {
    ...
    void test() {
        ...
        try {
            ...
            System.out.println("Leaves: " + bTree.printLeaves());
            System.out.println();

            System.out.println("Nodes with One child : "  + bTree.printNodes1Child());
            System.out.println();

            System.out.println("Nodes with Two child " + bTree.printNodes2Children());
            System.out.println();

            System.out.println("Nodes with children: " + bTree.printNodesWithChildren());
            System.out.println();

            System.out.println("Sub tree" + bTree.printSubTree());
            System.out.println();
